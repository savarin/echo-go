...
type SchemaMigration struct {
	...
	Dirty   string      `boil:"dirty" json:"dirty" toml:"dirty" yaml:"dirty"`
...
var SchemaMigrationWhere = struct {
	...
	Dirty   whereHelperstring
}{
	Version: whereHelpernull_String{field: "\"schema_migrations\".\"version\""},
	Dirty:   whereHelperstring{field: "\"schema_migrations\".\"dirty\""},
}
...
var (
	...
	schemaMigrationColumnsWithoutDefault = []string{"dirty"}
	schemaMigrationColumnsWithDefault    = []string{"version"}
...
func FindSchemaMigration(ctx context.Context, exec boil.ContextExecutor, version null.String, selectCols ...string) (*SchemaMigration, error) {
...
func (o *SchemaMigration) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"schema_migrations\"", updateOnConflict, ret, update, conflict, insert)
...
func SchemaMigrationExists(ctx context.Context, exec boil.ContextExecutor, version null.String) (bool, error) {
	var exists bool
